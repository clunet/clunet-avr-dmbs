...
DMBS_BUILD_TARGETS         += 
DMBS_BUILD_MANDATORY_VARS  += DMBS_PATH CLUNET_BOOTLOADER_SUPPORT CLUNET_BOOTLOADER_ADDRESS
...
ifeq ($(CLUNET_BOOTLOADER_SUPPORT),)
 $(error CLUNET_BOOTLOADER_SUPPORT must be defined)
else
 CC_FLAGS   += -DCLUNET_BOOTLOADER_SUPPORT=$(CLUNET_BOOTLOADER_SUPPORT)
 ifneq ($(CLUNET_BOOTLOADER_SUPPORT), 0)
  # bootloader support enabled
  ifeq ($(CLUNET_BOOTLOADER_ADDRESS),)
   $(error CLUNET_BOOTLOADER_ADDRESS must be defined)
  endif
